...
namespace Ordering.Infrastructure.Migrations
{
    ...
    [Migration("20210916125626_AddBuyer")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ordering.Domain.AggregateModels.Buyer.Buyer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ordering.Domain.AggregateModels.Buyer.CardType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasDefaultValue(1);
            ...
            modelBuilder.Entity("Ordering.Domain.AggregateModels.Buyer.PaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ordering.Domain.AggregateModels.Buyer.PaymentMethod", b =>
                {
                    b.HasOne("Ordering.Domain.AggregateModels.Buyer.Buyer", null)
                        .WithMany("PaymentMethods")
                        .HasForeignKey("BuyerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ordering.Domain.AggregateModels.Buyer.CardType", "CardType")
                        .WithMany()
            ...
            modelBuilder.Entity("Ordering.Domain.AggregateModels.Ordering.Order", b =>
                {
                    ...
                    b.HasOne("Ordering.Domain.AggregateModels.Buyer.PaymentMethod", null)
                        .WithMany()
